...
<!-- Final Countdown JS -->
<script src="<?= base_url() ?>frontend/js/finalcountdown.min.js"></script>
<!-- Fancy Box JS-->
<script src="<?= base_url() ?>frontend/js/facnybox.min.js"></script>
<!-- Magnific Popup JS-->
<script src="<?= base_url() ?>frontend/js/jquery.magnific-popup.min.js"></script>
<!-- Circle Progress JS -->
<script src="<?= base_url() ?>frontend/js/circle-progress.min.js"></script>
<!-- Nice Select JS -->
<script src="<?= base_url() ?>frontend/js/niceselect.js"></script>
<!-- Jquery Steller JS-->
<script src="<?= base_url() ?>frontend/js/jquery.stellar.min.js"></script>
<!-- Jquery Steller JS-->
<script src="<?= base_url() ?>frontend/js/cube-portfolio.min.js"></script>
<!-- Slick Nav JS-->
