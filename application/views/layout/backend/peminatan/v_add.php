...
<div class="col-md-12">
	...
	<div class="card card-primary">
		...
		<div class="card-body">
			...
			echo form_open_multipart('peminatan/add') ?>
			<!-- text input -->
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						...
						<input name="nama_peminatan" type="text" class="form-control" placeholder="Nama Peminatan" value="<?= set_value('nama_peminatan') ?>">
					</div>
				</div>
			</div>
			<div class="form-group">
