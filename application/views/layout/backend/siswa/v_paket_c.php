                ...
                <div class="white_shd full margin_bottom_30">
                    <div class="full graph_head">
                        <div class="heading1 margin_0">
                            <a href="<?= base_url('siswa/addc') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Add</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($siswa as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('siswa/updatec/' . $value->id_siswa) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i>Update</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('siswa/deletec/' . $value->id_siswa) ?> " class="btn btn-primary">Delete</a>
                </div>
            </div>
        </div>
    </div>
